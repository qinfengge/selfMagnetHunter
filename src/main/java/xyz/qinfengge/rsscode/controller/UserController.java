...
import xyz.qinfengge.rsscode.entity.User;
import xyz.qinfengge.rsscode.service.UserService;
...
public class UserController {
     ...
     */
    @GetMapping
    public Result<Object> selectAll(Page<User> page, User user) {
     ...
     */
    @GetMapping("{id}")
    public Result<Object> selectOne(@PathVariable Serializable id) {
     ...
     */
    @DeleteMapping
    public Result<Object> delete(@RequestParam("idList") List<Long> idList) {
